...
import { usePresensiData } from './context/PresensiContext';

const Presensi = () => {
    const router = useRouter();
    const { user } = useAuth();
    const { formData, setFormData, questions, setQuestions } = usePresensiData();
    ...
    return (
        <div className="bg-white min-h-full dark:text-black">
